...
- **Shell** : L'interpréteur de commandes (bash, zsh)
- **Système de fichiers** : Organisation des fichiers
- **Utilitaires** : Outils de base (ls, cp, mv, etc.)
...
- **Ubuntu** : Ctrl + Alt + T
- **Raspberry Pi** : déjà ouvert par défaut
...
- **askubuntu.com** : Questions/réponses
- **linux.die.net** : Manuels en ligne
- **github.com** : Code source
