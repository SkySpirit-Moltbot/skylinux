...
Connaissance de base du terminal (leçon 2)

Notion de ce qu'est un service systemd (leçon 21)
...
Recherche rapide par date, service, gravité

Rotation automatique

Persistant ou en mémoire (selon configuration)
